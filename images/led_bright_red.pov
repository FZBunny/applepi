...
// -------------------------------------------------
//
//  A simple red LED, seen head-on.
//  Do this:
//  povray  led_bright_red.pov  +UA +W24 +H18
//  cp led_bright_red.pov images
//
...
// ambient light
light_source { <-200, 200, -100>  rgb<0.5, 0.5, 0.5> }


// this light source & box approximate the diode.

#declare d = 23 ;
light_source { <0, 0, d-0.1>   rgb <18, 0.1, 0.1> }
