...
extern const char* xpm_40ColChars_IIPlus[] ;
extern const char* xpm_40ColChars_IIe[] ;
extern const char* xpm_40ColCharsEnhanced[] ;

//extern const char* xpm_80ColChars_IIPlus[] ;
extern const char* xpm_80ColChars_IIe[] ;
