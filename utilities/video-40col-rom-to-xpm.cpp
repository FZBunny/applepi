/*****************************************************************************
    ...
    File: "video-40col-rom-to-xpm.cpp"
...
/****************************************************
  ...
  Read a 40-column Apple II video charcter ROM, and
...
{
    fprintf (stderr, "\nUsage:\n") ;
    fprintf (stderr, "   video-40col-rom-to-xpm [-r] [-i] <filename>\n") ;
    fprintf (stderr, "\nWhere:\n") ;
...
//fprintf (stderr, "charNo=%2.2x  G_invert=%i\n", charNo, G_invert) ;
